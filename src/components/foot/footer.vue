<template>
    <div class='foot'>
        ...
        <div class='foot_nav'>
            ...
            <div class='item' @click="go({path: `/search/${geohash}`})">
                <svg class='icon'>
                    <use :xlink:href="parent=='search' ? '#findActive':'#find' "></use>
                </svg>
            ...
            <div class='item' @click="go({path: '/profile'})">
                <svg class='icon'>
                    <use :xlink:href="parent=='profile' ? '#profileActive':'#profile' "></use>
                </svg>
